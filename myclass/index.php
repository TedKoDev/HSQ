        ...
        <div class="flex w-4/5 mx-auto justify-between">
            <div class="flex flex-col w-3/4 bg-gray-50 rounded-lg hover:shadow px-2">
                <div class="flex justify-between mt-2 items-center">
                    <span class="classDate text-xs text-gray-700">2022년 12월 10일 토</span>
                    <span
                        class="classStatus text-xs bg-gray-200 text-gray-700 rounded-lg px-2 py-1">완료됨</span>
                </div>
                <span class="classTime text-2xl font-bold my-5">21:00 / 21:30</span>
                <hr class="bg-gray-300 border">
                <div class="flex justify-between my-5">
                    <div class="flex items-center">
                        <img
                            class="teacherImage mx-auto w-10 h-10 border-3 border-gray-900 rounded-full"
                            src="/images_forHS/userImage_default.png"></img>
                        <div class="flex flex-col ml-2">
                            <span class="teacherName text-sm text-gray-900">안해인</span>
                            <span class="teacherSpecial text-xs text-gray-400">커뮤니티 튜터</span>
                        </div>
                    </div>
                </div>
                <hr class="bg-gray-300 border border-1">
                <span class="className py-4">한국어 기초1</span>
                <div class="flex w-full">
                    <div class="flex flex-col w-1/4">
                        <span class="text-xs text-gray-400 mb-1">수업 유형</span>
                        <span class="text-sm text-gray-700">읽기 발음</span>
                    </div>
                    <div class="flex flex-col w-1/4">
                        <span class="text-xs text-gray-400 mb-1">소요 시간</span>
                        <span class="text-sm text-gray-700">30<span class="text-sm text-gray-700">분</span></span>
                    </div>
                    <div class="flex flex-col w-1/4">
                        <span class="text-xs text-gray-400 mb-1">요금</span>
                        <div class="flex">
                            <span class="text-sm text-gray-700">$</span><span class="text-sm text-gray-700 mx-1">6</span>
                            <span class="text-sm text-gray-700">USD</span>
                        </div>
                    </div>
                </div>
                <span class="text-sm py-4">수업 설명</span>
                <hr class="bg-gray-300 border border-1">
                <div class="flex items-center">
