...
if ($kind == 'cdetail') {
  ...
  if ($clReserveCheck  == null) {
    ...
    $send['class_register_review'] = $row1['class_register_review'];   //  신청한 수업 강사의 review 작성여부    
    ...
    $teacherStudentReviewSql = "SELECT Class_Teacher_Review.teacher_review, CONVERT_TZ (Class_Teacher_Review.teacher_review_date, $timezero ,$timezone2),
   Class_Student_Review.student_review,Class_Student_Review.student_review_star,CONVERT_TZ (Class_Student_Review.student_review_date, $timezero ,$timezone2)
