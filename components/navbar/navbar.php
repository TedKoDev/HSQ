        ...
        <div class="flex justify-between">
            <div class="flex">
                ...
                <div class="hidden md:flex items-center space-x-1 ml-3">
                    <a href="/findteacher/" class="py-1 px-2 text-gray-700 hover:text-gray-900 hover:bg-gray-400 rounded">강사</a>
                    <a href="/findclass/" class="py-1 px-2 text-gray-700 hover:text-gray-900 hover:bg-gray-400 rounded">수업</a>
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a href="/message/" id="msg_icon" class="bg-gray-300 hover:bg-gray-400 rounded-full p-1.5">
                    ...
                    <svg class="" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                ...
                <div id="id_user_info" class="ml-1 w-20 relative flex justify-center items-center focus:outline-none rounded group
                  ">
                    <img id="user_image" class="mx-auto w-8 h-8 border-2 border-gray-900 rounded-full" src="<?php echo $hs_url; ?>images_forHS/userImage_default.png">
                    </img>
                ...
                <!-- 로그인/회원가입 -->
                <a id="id_login" href="../login/" class="hidden py-1 px-3 hover:bg-gray-400 hover:text-gray-800 rounded">로그인</a>
                <a id="id_signup" href="../signup/" class="hidden py-1 px-3 bg-yellow-300 hover:bg-yellow-500 text-yellow-900 hover:text-yellow-900 rounded
