...
<html>
    ...
    <script type="module" defer="defer" src="./reviewlist.js"></script>
            ...
            <div class="filter hidden">
                <form action='/teacherpage/classhistory/classlist/' method='get'>
                    <div class="flex w-full">
                        <select
                            id="selector"
                            class="classType selectClassType w-1/3 px-1 py-1 rounded border border-gray-200 mb-3 mx-1"
                            name="class_type"
                            required="required">
                            <option value="" disabled="disabled" selected="selected" hidden="hidden">수업 상태</option>
