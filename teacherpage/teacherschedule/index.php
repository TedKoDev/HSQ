...
<html>
    ...
    <script type = "module" src="./teacherschedule.js" defer="defer"></script>
        ...
        <div class = "w-5/6 bg-gray-50 rounded-lg shadow mx-auto"><br>
            <div class = "px-4">
                <div class = "flex justify-between">
                    ...
                    <a href = "../manageschedule/" class = "bg-blue-500 text-white hover:bg-blue-600 px-3 py-1 rounded-lg">일정 관리</a>
                </div><br><br>                
