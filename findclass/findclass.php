...
<html>
    ...
    <body class="bg-gray-100">
        ...
        <div class = "flex-col justify-center mx-auto max-w-3xl items-center">
            <div class = "font-bold text-2xl">한글스퀘어 수업</div><br>     
            <div class="flex justify-end">
                <div class="mb-3 xl:w-80">
                    <div class="flex items-stretch w-full">
                        <input type="search" class="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="수업 이름" aria-label="Search" aria-describedby="button-addon2">
