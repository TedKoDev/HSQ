...
<html>
    ...
    // 필터 찾기 할 경우 서버에 보낼 json
    let request_to_server = {
            ...
            <div class = "flex w-full px-3 mb-3 justify-between mx-auto py-2">
                ...
                <div>
                    <div class="flex justify-end">
                        <input type="search" class="search_input form-control flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="수업 이름" aria-label="Search" aria-describedby="button-addon2">
                        <button class="search_btn px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
