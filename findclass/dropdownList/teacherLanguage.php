<div id="teacherLanguage" class="hidden z-10 w-60 bg-white rounded-xl shadow">
    <div class = "my-2 justify-center px-1">            
        <?php foreach ($languageList as $language) {        
            ...
            <label for="<?php echo $language; ?>" class="text-gray-800 bg-gray-300 hover:bg-gray-400 font-medium rounded-2xl text-xs px-2 mx-1 py-2 my-1 text-center inline-flex items-center"
